...
const RECLAIM_WINDOW = 5, STOP_BUFFER_PCT = 3, MAX_HOLD = 60, CALENDAR_DAYS = 2555, MIN_ENTRY_POSITION_PCT = 20, MIN_BAND_WIDTH_PCT = 2.5; // STOP_BUFFER_PCT v15(2026-08-26): 청산 그리드서치 재확정(2→3)
