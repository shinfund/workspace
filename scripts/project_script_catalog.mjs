...
const CATALOG = [
  {
    ...
    items: [
      ...
      { script: 'project_kospi_mktcap_top50_quote_table.mjs', desc: '코스피 시가총액 TOP50 시세표 — 현재가·등락률·시총+EMA5/20/50/100/200, 섹터별 시세표+요약 자동 첨부 (--top N으로 순위 조절)' },
      { script: 'project_kosdaq_mktcap_top20_quote_table.mjs', desc: '코스닥 시가총액 TOP20 시세표 — 현재가·등락률·시총+EMA5/20/50/100/200, 섹터별 시세표+요약 자동 첨부 (--top N으로 순위 조절)' },
    ],
  },
  {
    category: '2. 보유종목 현황표',
