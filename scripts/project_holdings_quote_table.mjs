 ...
 * 자릿수가 아니라 "화면에 보이는 최근 구간의 가격범위"로 정해짐을 확인 — 삼성전자 25,000원/SK하이닉스
 * 250,000원 축 간격 모두 "최근 200거래일 고가~저가 범위 ÷ 목표눈금10개"를 1/2/2.5/5/10 계열의
 * "보기 좋은 수"(niceStep, D3.js 축 눈금 알고리즘과 동일 계열)로 반올림하면 정확히 재현됨.
